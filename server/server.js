...
const {
  ...
  getTopPlayers,
  deletePlayer
} = require("./service/playersService");
...
const {
  ...
  deleteTournament
} = require("./service/tournamentsService");
...
const {
  ...
  getOngoingMatches,
  getMatchById
} = require("./service/matchesService");
...
app.get("/api/clubs/:id/top3", getTopPlayersByClubId);
...
app.listen(3000, () => {
  console.log("Server käivitatud pordil 3000");
});